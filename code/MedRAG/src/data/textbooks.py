...
if __name__ == "__main__":
    ...
    fdir = "MedRAG/corpus/textbooks/en"
    fnames = sorted(os.listdir(fdir))

    if not os.path.exists("MedRAG/corpus/textbooks/chunk"):
        os.makedirs("MedRAG/corpus/textbooks/chunk")
        
    for fname in tqdm.tqdm(fnames):
        fpath = os.path.join("MedRAG/corpus/textbooks/en", fname)
        ...
        with open("MedRAG/corpus/textbooks/chunk/{:s}".format(fname.replace(".txt", ".jsonl")), 'w') as f:
            f.write('\n'.join(saved_text))
